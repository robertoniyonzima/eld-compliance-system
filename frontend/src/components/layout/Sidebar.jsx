...
const Sidebar = ({ activePage }) => {
  ...
  const getMenuItems = () => {
    ...
    // Menu normal pour drivers/managers
    return [
      { icon: '📊', label: 'Dashboard', href: '/driver', roles: ['driver', 'manager', 'admin'] },
      { icon: '📝', label: 'ELD Logs', href: '/logs', roles: ['driver', 'manager', 'admin'] },
      { icon: '🗺️', label: 'Trip Planner', href: '/trips', roles: ['driver', 'manager', 'admin'] },
      { icon: '👥', label: 'Administration', href: '/admin', roles: ['admin', 'manager'] },
      { icon: '⚙️', label: 'Settings', href: '/settings', roles: ['driver', 'manager', 'admin'] },
    ];
  };
